  ...
  return (
    <>
      <Routes>
        ...
        <Route path='/privacypolicy' element={[<><div className='user_body'><PrivacyPolicy /></div></>]} />
        <Route path='/admin' element={[<> <AdminSideNavbar /><AdminTopNavbar flag={flag} /><div className='admin_body'><AdminDashboard /></div><AdminFooter /> </>]} />
