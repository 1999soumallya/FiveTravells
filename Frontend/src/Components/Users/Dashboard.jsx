                                ...
                                WeekFlightdetails.map((WeekFlightdetails) => (
                                    <div className="destime_table" key={WeekFlightdetails._id}>
                                        ...
                                        <div className="des_bookbtn">
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#PrePurchaseFlightModel" value={new Date(WeekFlightdetails.DEPARTURE_DATE).toISOString().slice(0, 10)} onClick={(e) => setFlightDate(e.target.value)}>
                                                ENQUIRE NOW
                                            </button>
                                ...
                                (
                                    Flightdetails.map((Flightdetails) => (
                                        <div className="destime_table" key={Flightdetails._id}>
                                            ...
                                            <div className="des_bookbtn">
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#PrePurchaseFlightModel" value={Flightdetails.DEPARTURE_DATE} onClick={(e) => setFlightDate(e.target.value)}>
                                                    ENQUIRE NOW
                                                </button>
